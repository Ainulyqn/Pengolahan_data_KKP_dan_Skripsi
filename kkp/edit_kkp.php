...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE kkp SET nama = '$nama', judul = '$judul', dosen_pembimbing = '$dosen_pembimbing' WHERE id = $kkpId";

    // Eksekusi query
    if (mysqli_query($conn, $query)) {
        // Redirect ke halaman detail.php setelah data berhasil diupdate
        header("Location: detail.php?id=$kkpId");
        exit;
    } else {
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tanggal" name="tanggal" value="<?php echo $kkp['tanggal']; ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="file" class="form-label">File</label>
                                <input type="text" class="form-control" id="file" name="file" value="<?php echo $kkp['file']; ?>" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="back-link">
                                <a href="detail.php?id=<?php echo $kkpId; ?>">Kembali ke Detail KKP</a>
                            </div>
                        </form>
                    </div>
                </div>
