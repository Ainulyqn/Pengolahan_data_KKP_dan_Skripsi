...
if (isset($_POST['edit'])) {
    ...
    // Query untuk mengupdate data Skripsi
    $query = "UPDATE skripsi SET judul='$judul', penulis='$penulis', pembimbing='$pembimbing' WHERE id=$id";

    // Eksekusi query
    if (mysqli_query($conn, $query)) {
        // Redirect ke halaman list_skripsi.php setelah data berhasil diupdate
        header("Location: list_skripsi.php");
        exit;
    } else {
...
// Proses penghapusan data Skripsi
if (isset($_POST['delete'])) {
    $id = $_POST['id'];

    // Query untuk menghapus data Skripsi
    $query = "DELETE FROM skripsi WHERE id=$id";

    // Eksekusi query
    if (mysqli_query($conn, $query)) {
        // Redirect ke halaman list_skripsi.php setelah data berhasil dihapus
        header("Location: list_skripsi.php");
        exit;
    } else {
        echo "Error: " . mysqli_error($conn);
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel<?php echo $id; ?>">Edit Skripsi</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="list_skripsi.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="penulis" id="penulis" class="form-control" value="<?php echo $penulis; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="pembimbing">Pembimbing:</label>
                            <input type="text" name="pembimbing" id="pembimbing" class="form-control" value="<?php echo $pembimbing; ?>" required>
                        </div>
